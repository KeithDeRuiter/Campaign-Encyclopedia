 ...
 * @author adam
 */
public class DefaultCampaignDataManager implements CampaignDataManager {
    ...
    public DefaultCampaignDataManager() {
    ...
    public void addRelationship(Relationship rel) {
        //Get primary entity from relationship
        UUID entity = rel.getEntityId();

        // If primary end is missing a mgr, create it
